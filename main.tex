...
\begin{itemize}
    \item a \textbf{FastAPI backend}, responsible for authentication, authorization, workflow enforcement, document metadata, audit events, report export, hash verification, login throttling, and re-authentication for selected sensitive administrator actions;
...
\begin{figure}[htbp]
    ...
    \caption{Implementation architecture of the SCFCA proof of concept. \cite{Plantuml2}}
