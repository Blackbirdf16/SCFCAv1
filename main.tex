...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{docs//thesis-notes/figure11.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure 11.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure 12.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure23.png}
    \caption{Auditor dashboard showing the HTML audit report generated by the SCFCA proof of concept.}
    \label{fig:scfca-auditor-html-report}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure24.png}
    \caption{Auditor-facing hash verification for document and audit evidence in the SCFCA proof of concept.}
    \label{fig:scfca-auditor-hash-verification}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.92\textwidth}
        ...
        Suggested figure: checklist showing login, RBAC, ticket workflow, re-authentication,
        audit report, hash verification, and CI artifact review.
        \vspace{1.2cm}
    \end{minipage}
    }
...
After the implementation and DevSecOps phases were completed, a final reproducibility check was performed by synchronizing the final repository state across GitLab and the GitHub repositories used for source control and Overleaf integration, and by validating that the repository could be executed and tested from a clean working state.

This step is intended to verify that the CI/CD configuration, Docker setup, automated tests, security scanning jobs, documentation, and evidence artifacts do not depend on hidden local machine state. This strengthens the thesis evidence because it demonstrates that the repository is reproducible as an independent software artifact, not only as a local development folder.

The reproducibility evidence includes Git synchronization across the configured remotes, Docker Compose validation, backend compilation and application import checks, \texttt{pytest} execution, frontend build validation, and inspection of GitLab CI/CD evidence artifacts.
