...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/uni.png}\\[2cm]
    \label{fig:UMALOGO}
\end{figure}
...
{\huge \textbf{Secure Custody Framework for Cryptocurrency Assets (SCFCA)}}\\[3cm]


{\Large Design of a Secure Technical Framework for the Custody, Management, Preservation, and Auditing of Cryptocurrency Assets in Criminal Investigations}\\[5cm]




\textbf  Realizado por Lorela Elezaj\\
\textbf  Tutorizado por Antonio Maña \\[2cm]
\vfill
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{docs//thesis-notes/PDCA_MODEL.png}
...
\begin{itemize}
    \item \textbf{Visual Paradigm:} The Visual Paradigm project file used for the SCFCA modeling process is also preserved in the repository as part of the thesis evidence. This project file contains the modeling artifacts developed during the design phase, including Secure Tropos, requirements, domain, workflow, and architecture-related diagrams where applicable. Keeping the Visual Paradigm project under version control supports reproducibility and allows the exported thesis diagrams to be traced back to their original modeling source. \cite{VisualParadigmProject} 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{docs//thesis-notes/figure25.png}
    \caption{Class diagram of the main backend domain models and relationships in the SCFCA project. PlantUML \cite{Plantuml1} } 
...
The project used a combined modeling, implementation, validation, and documentation toolchain. Visual Paradigm was used for UML, Secure Tropos, requirements modeling, misuse-case analysis, domain modeling, and workflow diagrams. Microsoft Whiteboard was used as a supporting visual tool for early threat-graph modeling and for the design of selected explanatory figures. PlantUML was used for reproducible text-based architecture and implementation diagrams.

The proof-of-concept implementation was developed using Python with FastAPI for the backend, React/Vite for the frontend, and PostgreSQL for persistent storage. Visual Studio Code was used as the main development environment. Docker and Docker Compose were used to execute the backend, frontend, and PostgreSQL services in a reproducible local environment.

Git was used for version control. GitHub was used as the public repository and Overleaf synchronization mirror, while GitLab was used for CI/CD execution and DevSecOps evidence generation. The GitLab pipeline was used to run validation, testing, frontend build, Docker Compose checks, dependency audits, SAST, secret scanning, container scanning, configuration scanning, and baseline DAST evidence.

Overleaf and LaTeX were used for writing and formatting the thesis document. A web browser was used for Overleaf, repository access, CI/CD review, documentation, and online technical references. Generative AI tools were used only as support tools for drafting, revision, wording improvement, and review assistance; the technical design, implementation decisions, validation, and final responsibility remain those of the author.
...
\begin{figure} [htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure12.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{docs//thesis-notes/figure10.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure9.png}
...
\begin{figure} [htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure11.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure1.png}
    \caption{Initial high-level use-case overview of the SCFCA system.}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure2.png}
    \caption{Tropos Analysis diagram (case handler’s goals)}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure3.png}
    \caption{Tropos Analysis Diagram ( Administrator’s goals)}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure4.png}
    \caption{Tropos Analysis Diagram ( Auditor’s goals) }
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure5.png}
    \caption{Tropos Analysis Diagram ( External Adversary’s goals)}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure6.png}
    \caption{Tropos Analysis Diagram ( Malicious Insider’s goals)}
    \label{fig:placeholder}
\end{figure}
...
\begin{longtable}{|p{1.2cm}|p{3.0cm}|p{3.0cm}|p{3.5cm}|p{3.6cm}|}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure7.png}
    \caption{Tropos Analysis Diagram (Threat-goals relations)}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/Figure8.png}
    \caption{Tropos Analysis Diagram (Mitigation Measures )}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure13.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure14..png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure15.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure16.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure18.png}
...
As shown in Figure~\ref{fig:domain-class-diagram}, the central workflow is organized
...
\begin{figure} [htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure19.png}
    \caption{Domain class diagram of the SCFCA core data structures.}
    \label{fig:domain-class-diagram}
\end{figure}

The domain class diagram in Figure~\ref{fig:domain-class-diagram} complements the backend-oriented class diagram presented earlier in Figure~\ref{fig:class-diagram}. While Figure~\ref{fig:class-diagram} focuses on the implemented backend model structure, Figure~\ref{fig:domain-class-diagram} presents the conceptual domain model used to explain the SCFCA custody architecture.

\begin{figure} [htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure17.png}
...
\begin{figure}[H]
    ...
    \caption{Activity diagram for case creation, ticket approval, and custody execution in SCFCA.\cite{AD}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure20.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure21.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{docs//thesis-notes/figure22.png}
...
\subsection*{Repository Structure as Proof-of-Concept Evidence}
\addcontentsline{toc}{section}{Repository Structure as Proof-of-Concept Evidence}

The SCFCA repository was organized to support both implementation and validation. It does not contain only application code; it also contains the execution environment, automated tests, security evidence, diagrams, scripts, documentation, and CI/CD configuration required to reproduce and review the proof of concept.

\begin{verbatim}
SCFCA/
|-- backend/                    FastAPI backend and security enforcement logic
|-- frontend/                   React/Vite user interface
|-- tests/                      Automated functional and security tests
|-- scripts/                    Demo seeding and evidence report scripts
|-- docs/evidence/              Security reports and validation evidence
|-- docs/current-implementation/ Current implementation record and phase docs
|-- docs/traceability/          Requirements traceability matrices
|-- diagrams/                   Thesis diagrams and exported architecture figures
|-- docker-compose.yml          Reproducible local runtime
|-- .gitlab-ci.yml              CI/CD validation and security pipeline
`-- README.md                   Execution and demonstration guide
\end{verbatim}

This structure supports the proof-of-concept objective because the system can be executed, seeded, tested, scanned, documented, and reviewed from the repository itself. Therefore, the repository acts not only as a code archive, but also as a validation package for the thesis.\cite{REPO1} \cite{REPO2}

In practical terms, the proof of concept allows a reviewer to start the system with Docker Compose, seed deterministic demo data, log in as different institutional roles, observe role-based visibility differences, create and review custody workflow tickets, inspect document hash metadata, export audit reports, verify document or audit hashes, verify the audit hash chain, and review CI/CD security evidence generated by the repository.

\section{Development Model and Repository Evidence}
\label{sec:development-model-repository-evidence}

The Secure Custody Framework for Cryptocurrency Assets (SCFCA) was implemented as a thesis-oriented proof of concept designed to validate the main architectural and security controls defined in the previous chapters. The implementation follows an iterative and incremental development model. The project was first stabilized around its base repository structure, backend, frontend, database, and execution environment, and was then progressively strengthened through automated testing, Docker-based execution, GitLab CI/CD validation, security scanning, implementation documentation, traceability mapping, and evidence artifact generation.

The purpose of the proof of concept is not to deliver production custody software, but to demonstrate that the central security properties of the SCFCA architecture can be translated into executable and reviewable software evidence. In particular, the implementation validates backend-enforced role-based access control, case-assignment visibility boundaries, ticket-based governance, administrator approval workflows, document integrity metadata, tamper-evident auditability, login throttling, re-authentication for selected sensitive administrator actions, and reproducible DevSecOps evidence generation.

The repository was therefore treated not only as a code archive, but also as a validation package. It contains the implementation, execution configuration, automated tests, security evidence, diagrams, documentation, traceability material, and CI/CD configuration required to reproduce and review the proof of concept. Table~\ref{tab:scfca-repository-evidence} summarizes how the main repository areas support the validation of the SCFCA proof of concept.

\begin{table}[htbp]
\centering
\caption{Repository evidence supporting the SCFCA proof of concept}
\label{tab:scfca-repository-evidence}
\begin{tabular}{p{0.24\textwidth} p{0.36\textwidth} p{0.30\textwidth}}
\hline
\textbf{PoC Area} & \textbf{Evidence in Repository} & \textbf{Validation Contribution} \\
\hline
Backend implementation & FastAPI backend with authentication, case management, ticket workflows, document handling, audit events, hash verification, login throttling, and re-authentication & Demonstrates that the proposed architecture was translated into executable server-side logic \\
\hline
Frontend implementation & React/Vite interface for role-based interaction by regular users, administrators, and auditors & Supports visual demonstration of institutional workflows and role-specific views \\
\hline
Persistence layer & PostgreSQL-backed users, cases, tickets, documents, assets, approvals, valuation snapshots, assignments, and audit events & Validates that access control and workflow behavior operate over persistent records rather than temporary in-memory data \\
\hline
Security controls & RBAC, signed session cookie, CSRF protection, login throttling, re-authentication, SHA-256 document hashing, asset immutability, and audit hash-chain verification & Provides implementation evidence for the main security requirements defined in the architecture \\
\hline
DevSecOps pipeline & GitLab CI/CD with SCA, SAST, secret scanning, Trivy, Checkov, OWASP ZAP, and build/test validation & Demonstrates that validation and security checks are integrated into the software development lifecycle \\
\hline
Evidence artifacts & JSON and HTML reports, security evidence folders, traceability documents, implementation records, and retained CI artifacts & Supports auditability, traceability, and human-readable review of security evidence \\
\hline
Automated tests & Workflow tests, security hardening tests, audit hash-chain tests, asset immutability tests, malformed-input tests, model tests, and frontend build checks & Provides repeatable evidence that selected functional and security properties were verified \\
\hline
Docker runtime & Docker Compose execution with backend, frontend, PostgreSQL, and container hardening controls & Supports reproducibility of the proof-of-concept environment and validates the deployment model \\
\hline
\end{tabular}
\end{table}

This implementation model reflects two technical dimensions of the thesis. The first dimension is the secure custody governance model: the system must enforce separation of duties, restricted visibility, approval workflows, privileged action confirmation, and auditability. The second dimension is the secure software engineering model: the repository must provide evidence that the system can be tested, built, scanned, documented, and reproduced in a controlled way. This is aligned with DevOps and DevSecOps principles, where validation, automation, and feedback are integrated into the software lifecycle rather than treated as final manual activities~\cite{Kim2016,Vehent2018}.

Figure~\ref{fig:scfca-implementation-architecture} provides a high-level view of how these implementation and validation elements are connected in the proof-of-concept architecture. The internal organization of the prototype is described in more detail in Section~\ref{sec:implemented-prototype-architecture}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/scfca_poc_architecture.png}
...
\label{sec:implemented-prototype-architecture}

While the previous section described the development model, repository evidence, and validation package, this section describes the internal architecture of the implemented proof of concept. The objective is to show how the main SCFCA controls are distributed across the frontend, backend, persistence layer, audit layer, and DevSecOps evidence layer.

The proof of concept is organized as a modular client-server application. The frontend handles interaction and presentation, while the backend remains the security-critical control point. This distinction is essential: role checks, workflow restrictions, document hashing, audit generation, privileged action confirmation, and report access are enforced by backend logic rather than by client-side interface restrictions.
...
\begin{itemize}
    ...
    \item \textbf{API layer:} FastAPI endpoints exposing authentication, re-authentication, cases, tickets, documents, audit, health, and internal communication functionality.
    \item \textbf{Security enforcement layer:} backend dependencies and middleware for session validation, RBAC checks, CSRF protection, login throttling, re-authentication token validation, and role-restricted endpoints.
    \item \textbf{Persistence layer:} PostgreSQL-backed domain records for users, cases, assets, documents, tickets, approvals, assignments, valuation snapshots, and audit events.
    \item \textbf{Audit and integrity layer:} audit event recording, hash-chain fields, audit-chain verification, document hash metadata, auditor report export, and hash verification.
    \item \textbf{DevSecOps evidence layer:} GitLab CI/CD jobs and retained artifacts generated by tests, builds, scanners, report converters, and manual validation evidence.
\end{itemize}

This layered organization supports the architectural claim made in Chapter~\ref{ch:system-architecture}. SCFCA is not only a set of requirements, but a software architecture where security controls are embedded in workflow logic, domain records, and validation evidence.

The frontend is deliberately treated as a presentation and interaction layer, not as a trusted security boundary. It can guide users through role-specific views and hide actions that are not relevant to their role, but it does not determine whether an action is authorized. A manipulated client could still attempt to send direct HTTP requests; therefore, all security-relevant decisions must be enforced by the backend.

The backend acts as the main control point of the proof of concept. It validates authenticated sessions, applies role-based access control, enforces case-assignment restrictions, validates CSRF tokens for state-changing requests, requires re-authentication tokens for selected sensitive administrator actions, computes document hashes, records audit events, and exposes auditor-facing verification and reporting functions. This design ensures that security decisions remain under server-side control.

The persistence layer gives the proof of concept stronger validation value than an in-memory demonstration. Users, cases, assignments, assets, frozen valuation snapshots, tickets, approvals, documents, and audit events are stored as persistent records. This allows the same dataset to be inspected from different role perspectives and makes role-based visibility, workflow state, document metadata, and audit traceability demonstrable across executions.

The audit and integrity layer supports the evidentiary objective of the framework. Audit events are recorded with integrity metadata, including previous-hash and hash-chain fields, so that later verification can detect broken continuity or modified event content. Uploaded PDF documents are associated with backend-generated SHA-256 hash metadata. These mechanisms do not make the database physically immutable, but they demonstrate how tamper-evident traceability can be implemented within the proof-of-concept scope.

Finally, the DevSecOps evidence layer surrounds the application with repeatable validation. The GitLab pipeline, scanner outputs, JSON artifacts, HTML reports, tests, and manual validation evidence make the repository reviewable as an engineering artifact. This supports the thesis argument that secure custody systems require not only secure workflows, but also evidence that the software used to enforce those workflows can be built, tested, scanned, and reviewed in a controlled manner.

\subsection{Backend Structure}

The backend is implemented in Python using FastAPI. It exposes API routes for the main system areas: authentication, re-authentication, cases, tickets, documents, audit, health checks, and internal communication. The backend is the primary enforcement point for the proof of concept.

This organization separates domain concerns such as cases, tickets, documents, audit events, authentication, and privileged action confirmation into distinct backend areas. This supports maintainability and makes the implementation easier to map to the architectural models and traceability matrices defined elsewhere in the thesis.
...
The backend also implements the workflow restrictions required by SCFCA. Regular users can create custody workflow tickets only for cases assigned to them. Administrators can create custody cases, view all tickets, assign tickets, and approve or reject ticket requests, but they cannot initiate regular custody workflow tickets. Auditors are restricted to audit metadata, report export, and hash-verification functionality, without operational modification privileges.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/backend_domain_api_structure.png}
    \caption{Backend domain and API structure of the SCFCA proof of concept. \cite{Plantuml3}}
    \label{fig:backend-domain-api-structure}
\end{figure}

\subsection{Frontend Structure}

The frontend is implemented using React, TypeScript, and Vite. Its role is to provide a clear operational interface for the different institutional roles. The frontend supports login, dashboards, case views, ticket workflows, document metadata, audit review, report export, hash-verification interactions, and re-authentication prompts before selected sensitive administrator actions.
...
For administrator actions that are considered sensitive in the proof of concept, the frontend now performs a minimal password-confirmation step. After successful re-authentication, the frontend sends the resulting \texttt{X-Reauth-Token} only with the protected administrative request. This improves the demonstration of privileged action confirmation without treating the frontend as the authorization authority.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/frontend_component_type_model.png}
    \caption{Frontend component structure of the SCFCA proof of concept. \cite{Plantuml4}}
    \label{fig:frontend_component_type_model}
\end{figure}

\subsection{Persistence Layer and Seeded Dataset}
...
This persistent dataset allows the same case, ticket, document, asset, valuation, and audit records to be inspected from different role perspectives, making the access-control boundaries demonstrable rather than only described.
...
\begin{itemize}
    ...
    \item administrators creating custody cases;
    \item administrators approving, rejecting, or assigning custody workflow tickets after re-authentication;
    \item the auditor reviewing audit metadata, exporting reports, verifying hashes, and verifying the audit hash chain.
\end{itemize}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/scfca_docker_compose_container_model.png}
    \caption{Docker Compose execution model for the SCFCA proof of concept.\cite{Plantuml5}}
    \label{fig:scfca-docker-compose-model}
\end{figure}

\section{Implementation of Core Security Logic}

The implementation focuses on the controls that are most important to the thesis: server-side authorization, assignment-based visibility, ticket governance, document integrity, auditability, login abuse reduction, privileged action confirmation, asset immutability, and DevSecOps evidence. These controls operationalize the security requirements defined in Chapter~\ref{ch:system-architecture}.

Each control corresponds to a specific architectural risk identified earlier in the thesis. Server-side RBAC addresses unauthorized access and privilege escalation. Assignment-based visibility addresses case data exfiltration and unauthorized case access. Ticket governance and administrator approval address bypass of custody authorization. Re-authentication addresses the risk of sensitive administrative actions being performed from an already-open session without recent credential confirmation. Login throttling reduces brute-force authentication abuse. Document hashing addresses evidence tampering. Asset immutability protects seized asset facts and frozen valuation data. Finally, audit hash chaining and audit-chain verification address log manipulation and support later verification of system activity.

\subsection{Authentication, Session Handling, CSRF Protection, and Login Throttling}
...
The implementation also includes proof-of-concept login throttling for repeated failed authentication attempts. The throttling mechanism is scoped only to the login endpoint. It tracks failed attempts using a normalized username and client IP combination. Before the threshold is reached, invalid credentials return controlled authentication errors. After repeated failures, the endpoint returns a generic \texttt{429 Too Many Requests} response. Successful authentication resets the failed-attempt counter for that identity.

This mechanism provides brute-force reduction evidence for the PoC, but it is intentionally not claimed as a production-grade distributed rate limiter. It is process-local and in-memory, and therefore resets when the backend process restarts. This limitation is acceptable within the academic proof-of-concept scope because it is documented honestly and validated through automated tests.

\subsection{Re-authentication for Sensitive Administrator Actions}

The implementation includes re-authentication for selected sensitive administrator actions. An active administrator session and CSRF token are not considered sufficient for these operations. Before performing the protected action, the administrator must confirm the current password through \texttt{POST /api/v1/auth/reauth}. If the password is correct, the backend returns a short-lived signed re-authentication token, which the frontend sends in the \texttt{X-Reauth-Token} header.

The token lifetime is five minutes. The token is bound to the authenticated user identity, so a token issued to one user cannot be reused by another user. Missing, invalid, expired, or cross-user tokens are rejected. In the current proof of concept, re-authentication is required for:

\begin{itemize}
    \item administrator custody case creation;
    \item ticket approval;
    \item ticket rejection;
    \item ticket assignment.
\end{itemize}

Re-authentication is intentionally not required for login, logout, current-user lookup, health checks, read-only views, regular-user ticket creation, document listing, audit viewing, or audit hash-chain verification. This narrow scope prevents unnecessary friction while protecting the administrative actions that have the strongest governance impact.

This control is password confirmation only, not MFA. It does not provide production-grade privileged access management and does not include a server-side token revocation list. Its purpose in the thesis is to demonstrate recent credential confirmation for selected sensitive administrator actions.
...
\begin{itemize}
    ...
    \item \textbf{Administrators} can create cases, view all cases and tickets, assign tickets, and approve or reject ticket requests.
    \item \textbf{Auditors} can access audit metadata, report export, hash verification, and audit hash-chain verification, but do not receive operational modification privileges.
\end{itemize}

This implementation directly supports least privilege, separation of duties, and restricted access to sensitive case information. It also reinforces the principle that the frontend is not part of the trusted authorization boundary.
...
The ticket workflow is the main governance mechanism for custody-related requests in the SCFCA proof of concept. Tickets are linked to existing cases and are used to request actions such as transfer, conversion, reassignment, or administrative metadata updates. Regular users create custody workflow tickets only for cases assigned to them. Administrators review those tickets and may approve, reject, or assign them.

A single administrator decision is not treated as an informal action; it is stored as part of the workflow state and remains visible for later audit review. The implementation stores administrator decisions as approval records rather than reducing the process to a simple visual status. This preserves evidence of who approved or rejected the request, at which stage, and when. Rejection finalizes the ticket as rejected and prevents the approval path from continuing.

Case creation is implemented as a separate administrative workflow and should not be confused with custody workflow ticket creation. Administrators may register new custody cases and assign them to case handlers, while regular custody-impacting actions remain governed by the ticket workflow. In this model, tickets are used for requests linked to existing cases, whereas case creation establishes the initial case record and custody context. Sensitive administrator actions in this workflow require recent password confirmation through the re-authentication mechanism described above.
...
The important point for the PoC is that the integrity value is calculated by the backend at upload time, not supplied by the user as an untrusted claim.
...
\subsection{Asset and Frozen Valuation Immutability}

The current implementation includes ORM-level immutability guards for seized asset facts and frozen valuation snapshots. Once asset facts such as asset identifier, symbol, network, wallet reference, quantity, asset type, protocol, case association, and registration timestamp have been persisted, the application ORM prevents those fields from being modified through normal application update paths. Similarly, core frozen valuation snapshot fields are protected from later modification.

This control supports the thesis requirement that original seized asset facts and frozen reference valuation data should not be silently changed after registration. In the proof of concept, the enforcement is implemented at the application ORM level. It is not claimed to be a database trigger, external immutable ledger, or production-grade evidentiary storage mechanism. Direct database writes or bulk update paths could bypass it, and this remains a documented limitation. Nevertheless, the implemented guard provides concrete validation that the application layer treats seized facts and frozen valuation snapshots as immutable records.

\subsection{Audit Trail and Tamper-Evident Traceability}

Auditability is implemented as a first-class part of the backend. Security-relevant
actions generate audit events containing metadata such as actor, role, action, entity
type, entity identifier, timestamp, source/session information where available, previous
hash, and current hash-chain value.

The \texttt{previous\_hash} and \texttt{event\_hash} fields stored in the
\texttt{AuditEvent} model create tamper-evident linkage between events. The objective
is not to claim that the database itself is physically immutable. Instead, the
proof-of-concept demonstrates that audit records can be chained so that unauthorized
modification of past entries becomes detectable during verification. This supports the
thesis objective of preserving traceability, accountability, and non-repudiation in
custody workflows.

The current implementation includes an auditor-only audit-chain verification endpoint.
This verifier recomputes event hashes, checks continuity between the
\texttt{previous\_hash} field and the hash of the preceding event, and detects broken
links or tampered event content. This is stronger than simple hash lookup because it
verifies the consistency of the chain rather than only checking whether a submitted hash
is known.

The auditor-facing functionality also includes filtered audit review, JSON report
export, HTML report export, and hash verification. The hash verification endpoint can
determine whether a submitted hash corresponds to a known document hash or
audit-event hash. This allows an auditor to verify integrity using safe metadata without
requiring access to confidential case narratives or document contents.

\paragraph{Production hardening path for audit integrity.}
The current proof of concept enforces tamper-evidence at the application layer through
hash-chaining and auditor-facing chain verification. A production deployment of SCFCA
would strengthen this guarantee through three complementary infrastructure-level
mechanisms.

First, PostgreSQL role separation and a dedicated append-only audit account: the
application database user is granted \texttt{INSERT} only on the \texttt{audit\_events}
table, while \texttt{UPDATE} and \texttt{DELETE} privileges are revoked entirely. This
ensures that even a fully compromised application session cannot silently overwrite or
remove existing audit records, making the append-only constraint enforceable at the
database engine level rather than relying solely on the ORM layer.

Second, a \texttt{BEFORE UPDATE OR DELETE} trigger on the \texttt{audit\_events} table
that raises an exception unconditionally. Combined with the role restriction above, this
creates a defence-in-depth barrier: the application layer enforces append-only behaviour
through the SQLAlchemy ORM guards already in place in the SCFCAv2 repository, while
the database trigger provides an independent enforcement point that survives any
application-layer bypass attempt.

Third, periodic external anchoring of the audit chain's latest cumulative hash to an
immutable external store. Suitable options include a write-once object storage bucket
with WORM retention (e.g.\ AWS S3 Object Lock, Azure Immutable Blob Storage) or a
transparency log such as Rekor~\cite{rekor}. Anchoring does not replace the
database-resident chain but provides an out-of-band integrity checkpoint: an attacker
who tampers with the database cannot retroactively alter a published anchor without
that divergence becoming detectable. The anchoring interval determines the maximum
undetectable tampering window and should be aligned with the evidentiary requirements
of the applicable judicial procedures.

Together, these three layers move the audit integrity guarantee from
\emph{detectable tampering} to \emph{structurally prevented tampering}, which is the
appropriate assurance level for a custody platform that produces evidence admissible in
judicial proceedings. Their implementation is outside the scope of the present
proof-of-concept but represents a well-defined and achievable next step in the
production hardening path described in Section~\ref{sec:futureWork}.
...
The implementation includes a DevSecOps evidence layer built around GitLab CI/CD. This layer is not separate from the proof of concept; it supports the thesis argument that secure custody systems must be validated not only through application behavior, but also through the software development ecosystem that produces the application.

This is relevant because SCFCA, like any modern software system, depends on third-party packages, container images, build scripts, configuration files, and CI/CD execution. A weakness in these elements could affect the trustworthiness of the final system even if the custody workflow itself is correctly designed. For this reason, the pipeline is used to generate repeatable evidence about tests, dependencies, static code properties, exposed secrets, container images, configuration files, and dynamic application behavior.

The GitLab pipeline is organized around validation, testing, build, and security stages. Security jobs are intentionally non-blocking at this stage. Their purpose is to preserve evidence, expose findings, and support triage, not to claim a mature production release gate or to prove that the system is vulnerability-free.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{diagrams/scfca_devsecops_pipeline_evidence.png}
    \caption{DevSecOps evidence flow in the SCFCA GitLab pipeline.\cite{Plantuml6}}
    \label{fig:scfca-devsecops-pipeline}
\end{figure}
...
The latest local verification after the final implementation hardening phase executed the test suite successfully with \texttt{59} passing tests. This number is not presented as a universal guarantee of correctness; it is a reproducibility checkpoint showing that the current repository state passes the implemented automated validation suite.

\begin{figure}[htbp]
        \centering
        \includegraphics[width=1\linewidth]{docs/thesis-notes/figure27.png}
        \caption{GitLab pipeline showing validate, test, build, and security stages.}
    \label{fig:scfca-gitlab-pipeline}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure62.png}
     \caption{GitLab CI/CD pipeline execution showing successful completion of the latest pipeline and available security, testing, build, and audit evidence artifacts.}
    \label{fig:gitlab-pipeline-artifacts-summary}
\end{figure}
...
This supports the software supply-chain view adopted in the thesis: dependencies are part of the system's trust boundary and must therefore be identified, monitored, and reviewed.
...
Infrastructure-as-Code and configuration scanning is performed with Checkov. The Checkov job scans Dockerfiles, YAML files, Docker Compose configuration, and GitLab CI configuration. This is relevant because insecure configuration can weaken the system even when application logic is correct. In the SCFCA context, Docker hardening, CI/CD configuration, and container execution are part of the software trust boundary.
...
The ZAP job produces JSON, HTML, and Markdown artifacts. This is useful because it provides both machine-readable and human-readable DAST evidence. The current ZAP baseline scan is unauthenticated, so it should be interpreted as baseline dynamic evidence rather than exhaustive application security testing. Its value in this PoC is to show that dynamic testing can be automated and preserved as reviewable evidence, not to replace a complete penetration test.

During validation, ZAP evidence was reviewed before and after a remediation step. The initial report identified browser-policy and security-header findings. After mitigation, the scan was repeated and the updated report showed a reduced set of findings. The remaining alerts are retained as evidence for review and future hardening rather than hidden or overstated as fully resolved. The corresponding screenshot evidence is provided in Appendix~\ref{app:reproducibility-validation-evidence}.
...
Examples of the human-readable ZAP evidence reports generated during validation are included in Appendix~\ref{app:reproducibility-validation-evidence}.
...
The validation combines automated tests, CI/CD execution, scanner evidence, Docker-based reproducibility, and manual validation. This combination is appropriate for a security-oriented proof of concept because security claims must be supported by executable behavior and reviewable evidence.

\subsection{Automated Functional and Security Tests}

The repository includes automated tests covering workflow behavior, model behavior, security hardening, audit hash-chain verification, asset immutability, login throttling, re-authentication, and malformed input handling. The tests are executed in GitLab CI against a PostgreSQL-backed environment after the demo seed script has populated the database.
...
\begin{itemize}
    ...
    \item login throttling limits repeated failed authentication attempts;
    \item re-authentication is required for selected sensitive administrator actions;
    \item regular users are restricted to assigned-case visibility;
    \item administrators can perform case creation and ticket review actions within the implemented governance model;
    ...
    \item audit hash-chain verification detects valid chains, broken previous-hash continuity, and tampered event content;
    \item asset immutability guards prevent modification of persisted seized asset facts and frozen valuation snapshot fields through normal ORM update paths;
...
Manual validation was used as a complementary evidence layer. Automated tests and scanners are necessary, but they do not fully replace human review of role behavior, workflow logic, and generated artifacts. The manual validation checklist documents the following checks:
...
\begin{itemize}
    ...
    \item administrator case creation with re-authentication;
    \item ticket approval, rejection, and assignment with re-authentication;
    ...
    \item document hash, audit hash, and audit hash-chain verification;
...
As a final validation step, the proof of concept was executed from a clean repository state following the project documentation. The objective of this check was not to introduce new functionality, but to verify that the final repository can be built, executed, seeded, tested, and reviewed using the same steps that would be followed by an external reviewer.

The reproducibility check started from the synchronized repository state shared across GitLab and GitHub. The working tree was verified to be clean, and the latest commit was confirmed before execution. Docker and Docker Compose availability were then checked on the host machine. The local runtime was reset using \texttt{docker compose down -v} in order to remove existing containers, networks, and PostgreSQL volumes, ensuring that the following execution did not depend on previous local state.

The application stack was then rebuilt and started using \texttt{docker compose up --build}. This step rebuilt the backend and frontend containers, created the Docker network and PostgreSQL volume, initialized the PostgreSQL database, and started the backend and frontend services. After startup, the backend health endpoint returned \texttt{200 OK}, confirming that the API service was reachable and operational.

The database was then populated using the demo seed script. The seed operation created the synthetic proof-of-concept dataset used for validation, including six demo users, assigned custody cases, shared-case behavior, assets, documents, tickets, and audit events. This confirmed that the demonstration environment can be reconstructed from the repository and does not require manually prepared database state.

After the runtime validation, the backend and frontend validation commands were executed. The backend compilation and application import checks completed successfully, including the explicit \texttt{APP\_IMPORT\_OK} confirmation. The automated test suite was executed with \texttt{pytest}, producing \texttt{59 passed} tests. The frontend production build was also executed successfully using \texttt{npm run build}. Finally, \texttt{docker compose config} was executed to validate and resolve the Docker Compose configuration, confirming the backend, frontend, PostgreSQL, network, and volume configuration.

This final reproducibility check provides evidence that the SCFCA proof of concept is not only described in the thesis, but can be rebuilt and validated from the repository. It also supports the claim that the implementation, Docker runtime, seeded data, automated tests, frontend build, and Compose configuration are reproducible from a clean local execution path. The detailed screenshot evidence for this final validation run is provided in Appendix~\ref{app:reproducibility-validation-evidence}.

\section{Analysis of Results}

The implementation and validation results support the central argument of the thesis: a governance-driven custody architecture can be translated into a working software system that enforces role separation, restricted visibility, ticket-based control, privileged action confirmation, auditability, document integrity metadata, asset immutability, and repeatable security evidence generation.
...
The third result is that the ticket workflow acts as a governance control. Custody-impacting requests are represented as tickets, administrator decisions are recorded, and rejected tickets are prevented from continuing through the approval path. Sensitive administrator actions such as case creation and ticket approval, rejection, or assignment require recent password confirmation through re-authentication.

The fourth result is that auditability is implemented as a concrete subsystem. Audit events are stored with metadata and hash-chain fields, and auditor-facing endpoints support report export, hash lookup, and audit-chain verification. This demonstrates that auditability is not merely described as a requirement, but implemented as a reviewable mechanism.

The fifth result is that selected data integrity controls are implemented in the application layer. Uploaded documents receive backend-generated SHA-256 hashes, audit events are linked through hash-chain metadata, and seized asset facts and frozen valuation snapshot fields are protected through ORM-level immutability guards. These mechanisms do not make the database itself physically immutable, but they demonstrate enforceable integrity controls within the proof-of-concept scope.

The sixth result is that the repository now includes a stronger DevSecOps evidence layer. The GitLab pipeline validates the backend, frontend, Docker configuration, dependencies, static analysis, secret exposure, container images, configuration files, and DAST behavior. JSON artifacts support traceability, while HTML reports support human review.
...
The implementation validates the governance, access-control, auditability, document integrity, asset immutability, Docker execution, and DevSecOps evidence aspects of SCFCA. It does not execute real blockchain transactions, manage real private keys, integrate production HSM or MPC infrastructure, or provide a certified institutional custody service.

Some security requirements are implemented directly in the current repository, such as backend RBAC, CSRF protection, signed session cookies, case-assignment visibility, login throttling, re-authentication for selected sensitive administrator actions, document hashing, audit event recording, audit hash-chain verification, asset immutability guards, report export, Docker hardening, and CI/CD evidence generation.

Other controls remain architectural or future-hardening items, especially MFA for privileged accounts, production-grade distributed rate limiting, production-grade privileged access management, production cryptographic custody, full external log anchoring, production secret management, authenticated DAST, runtime monitoring, signed provenance, and long-term durable binary evidence storage.
...
The immutability controls in the proof of concept are also scoped carefully. Asset immutability is enforced at the ORM/application layer, not through database triggers or external immutable storage. Audit hash-chain verification detects tampering or continuity breaks in stored audit records, but it does not make the underlying database physically append-only. These limitations are acceptable because the proof of concept is intended to validate the security architecture and implementation approach, not to replace a production evidence-management platform.
...
The implementation demonstrates that the core SCFCA controls can be operationalized: regular users are restricted by case assignment, administrators participate in controlled case creation and ticket approval/rejection/assignment, sensitive administrator actions require re-authentication, auditors receive read-only audit/report/hash-verification capabilities, documents are associated with SHA-256 integrity metadata, seized asset facts and frozen valuation snapshots are protected through ORM-level immutability guards, and security-relevant actions are recorded in a tamper-evident audit trail.
...
The next chapter concludes the thesis by summarizing the achieved objectives, the controlled scope boundaries of the proof of concept, and future work directions such as MFA for privileged accounts, hardware-backed custody integration, stronger runtime monitoring, authenticated DAST, signed provenance, external audit anchoring, and deeper institutional deployment hardening.
...
The first objective was to analyze the technical characteristics and security risks associated with institutional cryptocurrency custody. This objective was addressed through the study of custody models, governance challenges, security threats, and regulatory context. The analysis showed that the custody of confiscated cryptocurrency assets cannot be reduced to cryptographic key storage alone, but must also address governance, workflow control, accountability, auditability, and secure software construction in institutional environments. In this sense, the work successfully identified the central risks affecting such systems, including unauthorized access, insider abuse, privilege escalation, custody manipulation, audit tampering, evidence modification, and confidentiality breaches.

The second objective was to identify and model the relevant threats affecting institutional cryptocurrency custody systems. This objective was fulfilled through the misuse-case-driven threat analysis developed in the threat-modeling chapter. The work defined adversarial scenarios involving both external attackers and malicious insiders, mapped them to security goals, and linked them to explicit mitigation measures. This produced a structured traceability chain from misuse scenarios to requirements and from requirements to architectural and implementation controls.

The third objective was to define a secure custody architecture based on security-by-design principles, separation of duties, access control, and role management. This objective was achieved through the specification of the SCFCA reference architecture, including institutional actors, functional requirements, security requirements, non-functional requirements, trust boundaries, and governance mechanisms such as approval workflows, restricted execution authority, immutable asset facts, frozen valuation snapshots, auditability, and pseudonymous identity representation. The architecture also evolved to include secure software architecture considerations, dependency trust, container hardening, and software supply chain governance, thereby strengthening its alignment with modern DevSecOps and secure software design principles.

The fourth objective was to design a logging and auditing approach capable of supporting traceability, accountability, and non-repudiation. This objective was achieved both conceptually and at the proof-of-concept level. The proposed framework treats auditability as a first-class security property and not as a secondary administrative feature. The PoC demonstrates that meaningful system events can be recorded, linked to authenticated identities, protected with hash-chain metadata, and verified through an auditor-facing chain verification mechanism. This improves evidentiary reliability within the limits of the proof-of-concept implementation.

The fifth objective was to implement and validate a proof of concept capable of demonstrating the feasibility of the proposed architecture. This objective was fulfilled through the SCFCAv2 repository, which combines a FastAPI backend, React/Vite frontend, PostgreSQL persistence, Docker Compose execution, GitLab CI/CD validation, security scanning, implementation documentation, and traceability matrices. The implementation validates core controls such as server-side RBAC, case-assignment visibility, ticket governance, administrator-only case creation, document hashing, audit logging, audit hash-chain verification, asset immutability guards, login throttling, and re-authentication for selected sensitive administrator actions.

Finally, the work sought to align the proposed framework with European cybersecurity, governance, and risk-management principles while keeping it applicable to institutional contexts. This objective was addressed through the inclusion of regulatory context, resilience-oriented design choices, and the integration of DevSecOps concepts such as software supply chain visibility, monitoring-oriented evidence, and certifiability-oriented documentation.
...
Third, the implementation is not intended to represent a production-ready operational platform. Although it includes important security controls such as server-side RBAC, approval workflows, tamper-evident audit logging, login throttling, re-authentication for selected sensitive administrator actions, asset immutability guards, document hashing, and containerized execution support, it does not yet cover the full industrial requirements of a real institutional custody service. Areas such as multi-factor authentication for privileged accounts, high-availability deployment, hardened secret management, production network segmentation, full incident-response automation, infrastructure hardening, and large-scale operational monitoring would require substantial further development.

Fourth, the DevSecOps and software supply chain aspects of the prototype remain evidence-oriented rather than production-mature. The repository structure and pipeline configuration include practices such as automated testing, dependency scanning, static analysis, secret detection, container scanning, configuration scanning, DAST baseline scanning, and human-readable security evidence reports. However, these mechanisms are intentionally used as visibility and validation evidence in the thesis, not as mature production release gates. Accordingly, the thesis can claim DevSecOps-oriented validation and traceability, but not full industrial continuous-assurance maturity.

Fifth, the validation strategy remains limited to architectural correctness, feasibility demonstration, automated tests, scanner evidence, and workflow-oriented security evidence. It does not include formal verification of cryptographic protocols, independent penetration testing by external evaluators, empirical usability studies, red-team exercises, or long-term production deployment assessment. These omissions are not accidental; they reflect the intended scope of the thesis as a design-oriented and security-engineering contribution rather than a full operational certification exercise.

Sixth, some integrity controls are implemented at the application proof-of-concept level rather than through production-grade immutable infrastructure. Asset immutability is enforced through ORM-level guards, not through database triggers, write-once storage, or an external immutable ledger. Similarly, audit hash-chain verification can detect tampering or continuity breaks in stored audit records, but it does not make the underlying database physically append-only. These controls are valuable for demonstrating the architecture, but they would need stronger infrastructure support in a real institutional deployment.

Seventh, the current proof of concept does not implement a production network security architecture. The repository demonstrates application-layer controls, Docker Compose execution, and CI/CD security evidence, but it does not validate network segmentation, firewall policy, VPN or zero-trust administrative access, intrusion detection, or isolated custody-signing network zones. These aspects are fundamental for a real deployment, but they are outside the implemented scope of this thesis.

For these reasons, the prototype should be interpreted as evidence of feasibility and architectural coherence, not as a complete institutional custody product. Its value lies in demonstrating that the proposed governance-driven architecture can be implemented in software and can enforce the most critical controls required for secure institutional cryptocurrency custody within a controlled academic environment.
...
A third line of future work concerns privileged-access hardening. The current implementation includes login throttling and re-authentication for selected sensitive administrator actions, but it does not implement multi-factor authentication. A future version should add MFA for privileged users, especially administrators and possibly auditors, with careful attention to enrollment, recovery, usability, and auditability. This would strengthen protection against credential compromise while preserving the institutional workflow model.

A fourth line of future work concerns the expansion of the framework toward stronger software supply chain assurance. While this thesis already incorporates dependency trust, software composition visibility, security scanning, and DevSecOps-oriented validation evidence, future versions of SCFCA could implement these practices more fully. This includes automatic SBOM generation for every build, continuous Software Composition Analysis (SCA), stricter CI/CD security gates, artifact signing, preserved security-scan evidence per release, and stronger verification of dependency provenance. Such improvements would increase both operational security and institutional confidence in the software construction process itself.

Closely related to this is a fifth line of research focused on certifiability-by-design. The current architecture, repository organization, phase documentation, and traceability logic already suggest a path toward stronger audit and certification readiness. Future work could formalize this by linking requirements, code, tests, deployment records, scan results, manual validation evidence, and release artifacts into a more explicit assurance chain. This would improve the suitability of the framework for external audit, regulatory review, and high-assurance institutional adoption.

A sixth direction concerns monitoring and operational resilience in real deployment scenarios. The present work defines and demonstrates evidence-oriented validation, but future research could validate SCFCA in a live multi-environment deployment with centralized telemetry, alert correlation, anomaly detection, and incident-response automation. This would allow the framework to move from design-oriented runtime assurance toward experimentally validated continuous operational security.

Future validation should also include authenticated DAST covering role-specific workflows, since the current OWASP ZAP baseline scan is unauthenticated and therefore does not exercise the protected application surfaces behind login.

A further line of future work concerns the secure network architecture required for a real institutional deployment. The current proof of concept focuses on application security, workflow governance, auditability, and DevSecOps evidence, but it does not implement or validate a production network security architecture. In a real deployment, network security would be fundamental because the custody platform would need to protect backend services, database access, administrative interfaces, audit systems, CI/CD components, monitoring infrastructure, and any future cryptographic signing infrastructure. Future versions of SCFCA should therefore define and validate a segmented network architecture, separating public-facing components, internal application services, database systems, monitoring infrastructure, and custody-signing components into distinct security zones. This could include a DMZ for controlled external access, private backend and database subnets, strict firewall rules, administrative access through VPN or zero-trust controls, centralized logging, intrusion detection, and isolated network segments for HSM or MPC custody components. Within this thesis, such a network architecture remains outside the implemented scope, but a schematic secure network model could be added as a future architectural extension to demonstrate how the application-level controls would fit into a broader institutional security environment.

Finally, SCFCA could be extended beyond the specific institutional and national context that motivated this thesis. Although the work was framed with particular attention to the needs of public authorities managing confiscated cryptocurrency assets, future research could adapt the framework to different legal systems, regulatory environments, and operational models. Comparative adaptation across jurisdictions would be especially valuable for understanding which parts of the architecture are universally applicable and which must be tailored to local procedural or legal constraints.

In summary, the future evolution of SCFCA should move in three complementary directions: deeper custody realism, stronger assurance maturity, and secure deployment architecture. On one side, this means integrating real cryptographic infrastructure, advanced signing models, and live operational workflows. On another, it means strengthening software supply chain governance, monitoring, certifiability, and operational evidence. Finally, it requires designing and validating a secure institutional network architecture so that the custody platform can operate within a properly segmented, monitored, and hardened deployment environment. Together, these directions would help transform the present reference architecture into a more deployable and institutionally defensible custody platform.
...
\chapter{Proof-of-Concept Implementation Steps}
\begingroup
\footnotesize
...
\begin{longtable}{|p{6.2cm}|p{10cm}|}
\hline
\textbf{Implementation Step} & \textbf{Purpose} \\
\hline
\endfirsthead
...
Cleaned and stabilized the repository structure, Git remotes, and working tree before implementation. \\
\hline

 2 -- Docker Compose execution model &
Added and validated a local containerized execution model with frontend, backend, and PostgreSQL. \\
\hline

 3 -- Backend CI with PostgreSQL &
Updated backend tests in GitLab CI to use a PostgreSQL service and seeded test data. \\
\hline

 4 -- CI scanner command fixes &
Fixed scanner execution problems so Semgrep and Checkov could run and produce usable artifacts. \\
\hline

 5 -- Trivy container scanning &
Reworked backend and frontend image scans to run correctly in the CI environment. \\
\hline

 6 -- OWASP ZAP DAST &
Added a non-blocking OWASP ZAP baseline scan against the running frontend. \\
\hline

 7 -- Security input fuzzing &
Added property-based robustness tests for malformed authenticated API inputs. \\
\hline

 8 -- HTML security evidence reports &
Added human-readable HTML summaries for scanner outputs while preserving JSON artifacts. \\
\hline

 9A -- Checkov JSON output fix &
Adjusted Checkov report generation so JSON output could be consumed by the HTML report converter. \\
\hline

 9B -- Checkov parser fix &
Updated the HTML report converter to support Checkov list-root JSON reports. \\
\hline

 10 -- README validation update &
Updated project documentation to reflect current proof-of-concept capabilities, validation status, and evidence artifacts. \\
\hline

 11A -- Manual validation checklist &
Added manual validation evidence structure for role checks, workflow checks, screenshots, and thesis review. \\
\hline

 11B -- Security findings triage &
Added a triage document to classify scanner findings, remediations, deferred controls, and residual risks. \\
\hline

 11C -- Bandit B311 remediation &
Replaced pseudo-random demo case generation with deterministic fixture generation. \\
\hline

 11D -- Baseline HTTP security headers &
Added baseline HTTP security headers to backend and frontend responses. CSP and COEP were deferred. \\
\hline

 11E -- Frontend dependency remediation &
Applied safe non-force npm audit fixes and deferred Vite/esbuild major upgrade risks. \\
\hline

 11F -- Backend dependency audit review &
Verified backend Python dependencies with pip-audit. No dependency change was required. \\
\hline

 11G -- Container scan review &
Reviewed Trivy findings and classified remaining container and base-image risks. \\
\hline

 11H -- Final remediation verification &
Verified the post-remediation state using tests, frontend build, Docker Compose checks, and scanner evidence. \\
\hline

 12A -- PlantUML diagram sources &
Added PlantUML source diagrams for architecture, Docker Compose, and DevSecOps evidence flow. \\
\hline

 12B -- PlantUML SVG/PNG exports &
Rendered PlantUML diagrams into SVG and PNG files for thesis and presentation use. \\
\hline

 12C -- Diagram folder reorganization &
Moved existing diagrams into the PlantUML thesis diagram folder and removed unused diagram metadata. \\
\hline

 13A -- Audit hash-chain verification &
Added full audit-chain verification with hash recomputation, continuity checks, tamper detection, and an auditor-only verification endpoint. \\
\hline

 13B -- Asset immutability enforcement &
Added ORM-level guards preventing modification of persisted seized asset facts and frozen valuation snapshot fields. \\
\hline

 13C -- Login throttling / brute-force protection &
Added in-memory, proof-of-concept login throttling for repeated failed authentication attempts, scoped only to the login endpoint. \\
\hline

 13D -- Current implementation documentation and RTM alignment &
Rewrote the README and added current implementation documentation, testing guide, and traceability updates based on the actual SCFCAv2 repository. \\
\hline

 13E -- Re-authentication for sensitive administrator actions &
Added password re-authentication for selected sensitive administrative actions, including case creation and ticket approval, rejection, and assignment. \\
\hline

 14A -- Local demo URL standardization &
Standardized local demo URLs to \texttt{127.0.0.1} to avoid browser cookie and CSRF host-mismatch issues. \\
\hline

 14B -- Admin-only case creation &
Connected the frontend case creation form to a PostgreSQL-backed workflow restricted to administrators. \\
\hline

 14C -- Case creation audit evidence &
Added audit event generation and tests for administrator case creation. \\
\hline

 15A -- Ticket UI cleanup &
Separated Open Tickets, Create Ticket, and Closed Tickets views to reduce visual confusion. \\
\hline

 15B -- Role-based ticket navigation &
Adjusted ticket navigation for regular users, administrators, and auditors according to the SCFCA role model. \\
\hline

 15C -- Auditor-only audit access &
Restricted general audit-event access to the auditor role and denied administrators and regular users. \\
\hline

 15D -- Audit events pagination &
Added 15-event pagination with Older/Newer navigation for the auditor audit page. \\
\hline

 15E -- Auditor data minimization &
Restricted auditors away from operational case, asset, ticket, and document views. \\
\hline

 15F -- Assets page workflow cleanup &
Converted the Assets page into a read-only holdings and ticket-based custody request page, removing direct custody action forms. \\
\hline

 15G -- Dashboard cleanup &
Removed fake or confusing dashboard action buttons such as Deposit, Withdraw, and Cash In. \\
\hline

 16 -- Repository hygiene cleanup &
Removed tracked archive metadata and ignored local reference repositories to prevent old prototype files from being accidentally collected or committed. \\
\hline

 17 -- Final remote synchronization &
Synchronized the final working branch across GitLab, GitHub SCFCAv2, and GitHub SCFCAv1. \\
\hline

\caption{Phases and subphases followed during the implementation, validation, hardening, and documentation of the SCFCA proof of concept.}
\label{tab:phases-of-work}
\end{longtable}

\endgroup

\section{Step-to-Implementation File Mapping}

The previous table summarizes the implementation phases and their purpose. 
To complement that overview, Table~\ref{tab:phase-file-mapping} maps each phase to the main repository files, scripts, tests, and documentation artifacts affected during the development of the SCFCA proof of concept. 
This provides a compact implementation-level reference showing where each phase is reflected in the repository.
...
\begin{longtable}{|p{1.5cm}|p{4.8cm}|p{9.8cm}|}
\hline
\textbf{Phase} & \textbf{Work Performed} & \textbf{Main Files / Code} \\
\hline
\endfirsthead
...
1 & Repository stabilization &
\texttt{README.md}; \texttt{.gitignore}; repository root. \\
\hline

2 & Docker Compose execution model &
\texttt{docker-compose.yml}; \texttt{backend/Dockerfile}; \texttt{frontend/Dockerfile}; \texttt{.env.docker.example}. \\
\hline

3 & Backend CI with PostgreSQL &
\texttt{.gitlab-ci.yml}; \texttt{scripts/seed\_demo\_data.py}; \texttt{backend/requirements.txt}. \\
\hline
...
5 & Trivy container scanning &
\texttt{.gitlab-ci.yml}; \texttt{backend/Dockerfile}; \texttt{frontend/Dockerfile}. \\
\hline

6 & OWASP ZAP DAST &
\texttt{.gitlab-ci.yml}; \texttt{docs/evidence/dast/README.md}. \\
\hline

7 & Security input fuzzing &
\texttt{tests/test\_fuzz\_security\_inputs.py};
\texttt{docs/evidence/security-testing/README.md}. \\
\hline

8 & HTML security evidence reports &
\texttt{scripts/security\_reports\_to\_html.py}; \texttt{.gitlab-ci.yml}; \texttt{docs/evidence/security-reports/README.md}. \\
\hline
...
9B & Checkov parser fix &
\texttt{scripts/security\_reports\_to\_html.py}. \\
\hline
...
11A & Manual validation checklist &
\texttt{docs/evidence/manual-validation/README.md}; \texttt{README.md}. \\
\hline

11B & Security findings triage &
\texttt{docs/evidence/security-triage/README.md}; \texttt{README.md}. \\
\hline

11C & Bandit B311 remediation &
\texttt{backend/api/v1/routes/cases.py}. \\
\hline

11D & Baseline HTTP security headers &
\texttt{backend/main.py}; \texttt{frontend/vite.config.ts}; \texttt{docs/evidence/security-triage/README.md}. \\
\hline
...
11F & Backend dependency audit review &
\texttt{backend/requirements.txt}; GitLab \texttt{pip-audit} artifacts. \\
\hline

11G & Container scan review &
\texttt{backend/Dockerfile}; \texttt{frontend/Dockerfile}; \texttt{docs/evidence/security-triage/README.md}. \\
\hline

11H & Final remediation verification &
\texttt{tests/}; \texttt{frontend/}; \texttt{docker-compose.yml}; GitLab artifacts. \\
\hline

12A & PlantUML diagram sources &
\texttt{docs/diagrams/plantuml/*.puml}; \texttt{docs/diagrams/plantuml/README.md}. \\
\hline

12B & PlantUML SVG/PNG exports &
\texttt{docs/diagrams/plantuml/*.svg}; \texttt{docs/diagrams/plantuml/*.png}. \\
\hline

12C & Diagram folder reorganization &
\texttt{docs/diagrams/plantuml/}; \texttt{.gitignore}. \\
\hline

13A & Audit hash-chain verification &
\texttt{backend/api/v1/routes/audit.py}; \texttt{tests/test\_audit\_hash\_chain.py}; \texttt{tests/test\_workflows.py}; \texttt{pytest.ini}. \\
\hline

13B & Asset immutability enforcement &
\texttt{backend/core/models.py}; \texttt{tests/test\_asset\_immutability.py}; \texttt{tests/test\_workflows.py}. \\
\hline

13C & Login throttling / brute-force protection &
\texttt{backend/auth/login\_throttle.py}; \texttt{backend/api/v1/routes/auth.py}; \texttt{tests/conftest.py}; \texttt{tests/test\_security\_hardening.py}; \texttt{README.md}; \texttt{docs/current-implementation/}; \texttt{docs/traceability/}. \\
\hline

13D & Current implementation documentation and RTM alignment &
\texttt{README.md}; \texttt{docs/current-implementation/README.md}; \texttt{docs/current-implementation/implementation-record.md}; \texttt{docs/current-implementation/testing-guide.md}; \texttt{docs/traceability/current-requirements-traceability.md}; \texttt{docs/traceability/current-requirements-traceability-latex.md}. \\
\hline

13E & Re-authentication for sensitive administrator actions &
\texttt{backend/auth/reauth.py}; \texttt{backend/auth/schemas.py}; \texttt{backend/api/v1/routes/auth.py}; \texttt{backend/api/v1/routes/cases.py}; \texttt{backend/api/v1/routes/tickets.py}; \texttt{frontend/src/services/auth.ts}; \texttt{frontend/src/services/scfcaData.ts}; \texttt{frontend/src/pages/Cases.tsx}; \texttt{frontend/src/pages/Tickets.tsx}; \texttt{tests/test\_security\_hardening.py}; \texttt{tests/test\_workflows.py}. \\
\hline

14A & Local demo URL standardization &
\texttt{README.md}; \texttt{frontend/src/services/}. \\
\hline

14B & Admin-only case creation &
\texttt{backend/api/v1/routes/cases.py}; \texttt{frontend/src/pages/Cases.tsx}; \texttt{frontend/src/services/scfcaData.ts}; \texttt{tests/test\_workflows.py}. \\
\hline

14C & Case creation audit evidence &
\texttt{backend/api/v1/routes/cases.py}; \texttt{tests/test\_workflows.py}. \\
\hline

15A & Ticket UI cleanup &
\texttt{frontend/src/pages/Tickets.tsx}; \texttt{frontend/src/components/Sidebar.tsx}. \\
\hline

15B & Role-based ticket navigation &
\texttt{frontend/src/components/Sidebar.tsx}; \texttt{frontend/src/pages/Tickets.tsx}; \texttt{frontend/src/utils/roles.ts}. \\
\hline

15C & Auditor-only audit access &
\texttt{backend/api/v1/routes/audit.py}; \texttt{tests/test\_workflows.py}; \texttt{frontend/src/pages/Audit.tsx}. \\
\hline

15D & Audit events pagination &
\texttt{frontend/src/pages/Audit.tsx}; \texttt{frontend/src/services/dashboard.ts}. \\
\hline

15E & Auditor data minimization &
\texttt{frontend/src/app/routes.tsx}; \texttt{frontend/src/pages/CaseDetails.tsx}; \texttt{frontend/src/pages/Documents.tsx}; \texttt{frontend/src/pages/Dashboard.tsx}. \\
\hline

15F & Assets page workflow cleanup &
\texttt{frontend/src/pages/Assets.tsx}; \texttt{frontend/src/pages/Tickets.tsx}; \texttt{frontend/src/utils/roles.ts}. \\
\hline

15G & Dashboard cleanup &
\texttt{frontend/src/pages/Dashboard.tsx}; \texttt{frontend/src/services/dashboard.ts}. \\
\hline

16 & Repository hygiene cleanup &
\texttt{.gitignore}; removed tracked \texttt{\_\_MACOSX/} metadata files; ignored \texttt{old-repo-reference/}. \\
\hline

17 & Final remote synchronization &
Git remotes: \texttt{gitlab}; \texttt{origin}; \texttt{github-v1}. \\
\hline

\caption{Mapping of implementation phases to the main files and project locations affected.}
\label{tab:phase-file-mapping}
\end{longtable}


\chapter{Requirements Traceability Matrix}

This appendix maps the main SCFCA requirements to the current proof-of-concept implementation files, tests, and validation evidence. 
The purpose of this mapping is to show how the security and functional requirements defined in the architecture are reflected in the current SCFCAv2 repository.
...
\begin{longtable}{|p{1.1cm}|p{5.0cm}|p{9.0cm}|}
\hline
\textbf{Req. ID} & \textbf{Requirement Description} & \textbf{Implementation and Evidence} \\
\hline
\endfirsthead
...
FR-1 & User authentication and controlled access to the system &
Implemented in \texttt{backend/auth/schemas.py} and \texttt{backend/api/v1/routes/auth.py}. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

FR-2 & Role-based access control for regular users, administrators, and auditors &
Implemented through backend authentication and route dependencies under \texttt{backend/auth/} and \texttt{backend/api/v1/routes/}, with frontend role support in \texttt{frontend/src/utils/roles.ts}. Validated by \texttt{tests/test\_workflows.py} and manual role validation. \\
\hline

FR-3 & Case visibility restricted by role and case assignment &
Implemented in \texttt{backend/api/v1/routes/cases.py} and \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_workflows.py} and seeded demo case assignments. \\
\hline

FR-4 & Administrator-only custody case creation &
Implemented in \texttt{backend/api/v1/routes/cases.py}, \texttt{frontend/src/pages/Cases.tsx}, and \texttt{frontend/src/services/scfcaData.ts}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

FR-5 & Case assignment and assignment visibility &
Implemented through assignment records in \texttt{backend/core/models.py} and case access logic in \texttt{backend/api/v1/routes/cases.py}. Validated by \texttt{tests/test\_workflows.py} and seeded assignment records. \\
\hline

FR-6 & Ticket creation by authorized regular users for assigned cases &
Implemented in \texttt{backend/api/v1/routes/tickets.py} and \texttt{frontend/src/pages/Tickets.tsx}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

FR-7 & Administrators can approve, reject, and assign tickets &
Implemented in \texttt{backend/api/v1/routes/tickets.py}, \texttt{frontend/src/pages/Tickets.tsx}, and \texttt{frontend/src/services/scfcaData.ts}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

FR-8 & Administrators cannot initiate regular custody workflow tickets &
Implemented through backend ticket restrictions in \texttt{backend/api/v1/routes/tickets.py} and role-specific frontend behavior in \texttt{frontend/src/pages/Tickets.tsx}. Validated by \texttt{tests/test\_workflows.py} and role-based UI validation. \\
\hline

FR-9 & PDF-only document upload and document metadata registration &
Implemented in \texttt{backend/api/v1/routes/documents.py} and \texttt{frontend/src/pages/Documents.tsx}. Validated by \texttt{tests/test\_security\_hardening.py} and manual upload validation. \\
\hline

FR-10 & SHA-256 hashing of uploaded PDF evidence &
Implemented in \texttt{backend/api/v1/routes/documents.py} and stored through \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_security\_hardening.py} and auditor hash verification evidence. \\
\hline

FR-11 & Frozen valuation snapshot preservation &
Implemented in the persistence model in \texttt{backend/core/models.py} and represented in seeded demo data through \texttt{scripts/seed\_demo\_data.py}. Validated by \texttt{tests/test\_asset\_immutability.py}. \\
\hline

FR-12 & Asset fact immutability after registration &
Implemented through ORM-level immutability guards in \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_asset\_immutability.py}. \\
\hline

FR-13 & Audit event recording for meaningful system actions &
Implemented through audit logic in \texttt{backend/api/v1/routes/audit.py}, model support in \texttt{backend/core/models.py}, and event generation in routes such as \texttt{cases.py} and \texttt{tickets.py}. Validated by \texttt{tests/test\_workflows.py} and audit page evidence. \\
\hline

FR-14 & Auditor-only audit event access &
Implemented in \texttt{backend/api/v1/routes/audit.py}, \texttt{frontend/src/pages/Audit.tsx}, and \texttt{frontend/src/components/Sidebar.tsx}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

FR-15 & Audit event pagination for operational readability &
Implemented in \texttt{frontend/src/pages/Audit.tsx} and \texttt{frontend/src/services/dashboard.ts}. Validated through manual browser validation evidence. \\
\hline

FR-16 & Audit hash-chain verification &
Implemented in \texttt{backend/api/v1/routes/audit.py}. Validated by \texttt{tests/test\_audit\_hash\_chain.py} and \texttt{tests/test\_workflows.py}. \\
\hline

FR-17 & Document and audit hash verification support &
Implemented in \texttt{backend/api/v1/routes/audit.py} and \texttt{backend/api/v1/routes/documents.py}. Validated by \texttt{tests/test\_workflows.py} and auditor hash verification evidence. \\
\hline

FR-18 & Docker Compose reproducible local execution &
Implemented through \texttt{docker-compose.yml}, \texttt{backend/Dockerfile}, \texttt{frontend/Dockerfile}, and \texttt{.env.docker.example}. Validated with \texttt{docker compose config} and Docker runtime checks. \\
\hline

FR-19 & PostgreSQL-backed persistence for the proof of concept &
Implemented through \texttt{backend/core/models.py}, database configuration under \texttt{backend/db/}, \texttt{scripts/seed\_demo\_data.py}, and \texttt{docker-compose.yml}. Validated by CI backend tests with PostgreSQL and seeded demo validation. \\
\hline

FR-20 & Practical README and demo workflow documentation &
Implemented through \texttt{README.md} and \texttt{docs/current-implementation/README.md}. Validated by manual reproducibility review and thesis walkthrough. \\
\hline

SR-1 & Least-privilege enforcement &
Implemented through backend authorization logic under \texttt{backend/auth/}, protected API routes under \texttt{backend/api/v1/routes/}, and frontend role utilities in \texttt{frontend/src/utils/roles.ts}. Validated by \texttt{tests/test\_workflows.py} and role-based UI validation. \\
\hline

SR-2 & Separation of duties between regular users, administrators, and auditors &
Implemented through ticket workflow restrictions in \texttt{backend/api/v1/routes/tickets.py}, auditor restrictions in \texttt{backend/api/v1/routes/audit.py}, and role-specific navigation in \texttt{frontend/src/components/Sidebar.tsx}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

SR-3 & CSRF protection for state-changing requests &
Implemented through backend authentication/session logic and frontend HTTP request configuration. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

SR-4 & Login throttling / brute-force reduction &
Implemented in \texttt{backend/auth/login\_throttle.py} and integrated into \texttt{backend/api/v1/routes/auth.py}. Validated by \texttt{tests/test\_security\_hardening.py}. \\
\hline

SR-5 & Re-authentication for selected sensitive administrator actions &
Implemented in \texttt{backend/auth/reauth.py}, \texttt{backend/api/v1/routes/auth.py}, \texttt{backend/api/v1/routes/cases.py}, and \texttt{backend/api/v1/routes/tickets.py}. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

SR-6 & Tamper-evident audit hash-chain verification &
Implemented in \texttt{backend/api/v1/routes/audit.py} and supported by audit fields in \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_audit\_hash\_chain.py}. \\
\hline

SR-7 & Asset data immutability &
Implemented through ORM-level guards in \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_asset\_immutability.py}. \\
\hline

SR-8 & Document integrity protection through hashing &
Implemented in \texttt{backend/api/v1/routes/documents.py} and \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_security\_hardening.py} and document hash evidence. \\
\hline

SR-9 & Auditor privacy boundary and data minimization &
Implemented in \texttt{backend/api/v1/routes/audit.py}, \texttt{frontend/src/app/routes.tsx}, and \texttt{frontend/src/pages/Dashboard.tsx}. Validated by \texttt{tests/test\_workflows.py} and manual role validation. \\
\hline

SR-10 & Container hardening controls &
Implemented in \texttt{docker-compose.yml}, \texttt{backend/Dockerfile}, and \texttt{frontend/Dockerfile}. Validated by \texttt{docker compose config} and Trivy evidence. \\
\hline

SR-11 & DevSecOps security evidence generation &
Implemented in \texttt{.gitlab-ci.yml}, \texttt{scripts/security\_reports\_to\_html.py}, and \texttt{docs/evidence/}. Validated through GitLab CI artifacts and HTML security reports. \\
\hline

MU-1 & Unauthorized access mitigation &
Mitigated through authentication, login throttling, and re-authentication in \texttt{backend/api/v1/routes/auth.py}, \texttt{backend/auth/login\_throttle.py}, and \texttt{backend/auth/reauth.py}. Validated by \texttt{tests/test\_security\_hardening.py}. \\
\hline

MU-2 & Privilege escalation prevention &
Mitigated through server-side RBAC in \texttt{backend/auth/}, protected routes in \texttt{backend/api/v1/routes/}, and frontend role utilities in \texttt{frontend/src/utils/roles.ts}. Validated by \texttt{tests/test\_workflows.py} and security hardening tests. \\
\hline

MU-3 & Bypass of approval workflow prevention &
Mitigated through ticket workflow restrictions in \texttt{backend/api/v1/routes/tickets.py}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

MU-4 & Audit log tampering detection &
Mitigated through audit hash-chain verification in \texttt{backend/api/v1/routes/audit.py}. Validated by \texttt{tests/test\_audit\_hash\_chain.py}. \\
\hline

MU-5 & Asset manipulation prevention &
Mitigated through ORM-level immutability guards in \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_asset\_immutability.py}. \\
\hline

MU-6 & Document tampering detection &
Mitigated through document hashing in \texttt{backend/api/v1/routes/documents.py} and hash verification in \texttt{backend/api/v1/routes/audit.py}. Validated by document hash verification evidence. \\
\hline

MU-7 & Case data exfiltration reduction through assigned-case visibility &
Mitigated through case visibility restrictions in \texttt{backend/api/v1/routes/cases.py} and frontend route restrictions in \texttt{frontend/src/app/routes.tsx}. Validated by \texttt{tests/test\_workflows.py} and manual role validation. \\
\hline

MU-8 & Replay or unauthorized repeated custody action limitation &
Mitigated through ticket lifecycle records, approval state, and audit trail evidence in \texttt{backend/api/v1/routes/tickets.py}. Validated by ticket lifecycle tests and audit evidence. \\
\hline

MU-9 & Brute-force login abuse reduction &
Mitigated through login throttling in \texttt{backend/auth/login\_throttle.py} and \texttt{backend/api/v1/routes/auth.py}. Validated by \texttt{tests/test\_security\_hardening.py}. \\
\hline

\caption{Requirements Traceability Matrix linking SCFCA requirements to implementation files, tests, and validation evidence.}
\label{tab:requirements-traceability-matrix}
\end{longtable}

\chapter{Granular Security Requirements Mapping}


This appendix maps the main implemented security mechanisms to the specific controls, files, tests, and evidence artifacts that support them in the current SCFCAv2 proof of concept. 
The mapping is intentionally limited to controls that are actually implemented or explicitly documented as proof-of-concept controls.
...
\begin{longtable}{|p{3.0cm}|p{5.0cm}|p{7.0cm}|}
\hline
\textbf{Security Requirement} & \textbf{Implemented Control} & \textbf{Files / Tests / Evidence} \\
\hline
\endfirsthead
...
Authentication & Login, logout, and current-user session validation. &
Implemented in \texttt{backend/api/v1/routes/auth.py} and \texttt{backend/auth/schemas.py}. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

Signed Session Handling & Signed session cookie and authenticated principal resolution. &
Implemented in \texttt{backend/auth/} and \texttt{backend/api/v1/routes/auth.py}. Validated by auth workflow tests and manual login validation. \\
\hline

CSRF Protection & CSRF cookie and \texttt{x-csrf-token} header required for unsafe state-changing requests. &
Implemented through backend auth/session handling and frontend HTTP request configuration. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

Login Throttling & Failed-login throttling on \texttt{POST /api/v1/auth/login}. &
Implemented in \texttt{backend/auth/login\_throttle.py} and \texttt{backend/api/v1/routes/auth.py}. Validated by \texttt{tests/test\_security\_hardening.py}. \\
\hline

Re-authentication & Password confirmation for selected sensitive administrator actions. &
Implemented in \texttt{backend/auth/reauth.py}, \texttt{backend/api/v1/routes/auth.py}, and \texttt{frontend/src/services/auth.ts}. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

RBAC & Server-side role checks for protected endpoints. &
Implemented across \texttt{backend/auth/} and \texttt{backend/api/v1/routes/}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

Role-Based UI & Role-aware navigation and restricted frontend views. &
Implemented in frontend/src/ \texttt{components/Sidebar.tsx}, \texttt{app/routes.tsx}, and \texttt{utils/roles.ts}. Validated by manual browser validation and frontend build. \\
\hline

Assigned-Case Visibility & Regular users see only assigned case details. &
Implemented in \texttt{backend/api/v1/routes/cases.py} and \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

Admin Case Creation & Administrator-only case creation protected by re-authentication. &
Implemented in \texttt{backend/api/v1/routes/cases.py}, \texttt{frontend/src/pages/Cases.tsx}, and \texttt{frontend/src/services/scfcaData.ts}. Validated by \texttt{tests/test\_workflows.py} and re-authentication tests. \\
\hline

Ticket Governance & Ticket creation, approval, rejection, and assignment. &
Implemented in \texttt{backend/api/v1/routes/tickets.py} and \texttt{frontend/src/pages/Tickets.tsx}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

Sensitive Admin Action Gate & Re-authentication token required for case creation and ticket approval, rejection, or assignment. &
Implemented in \texttt{backend/auth/reauth.py}, \texttt{backend/api/v1/routes/cases.py}, and \texttt{backend/api/v1/routes/tickets.py}. Validated by \texttt{tests/test\_security\_hardening.py} and \texttt{tests/test\_workflows.py}. \\
\hline

PDF Upload Restriction & PDF-only supporting document upload. &
Implemented in \texttt{backend/api/v1/routes/documents.py} and \texttt{frontend/src/pages/Documents.tsx}. Validated by \texttt{tests/test\_security\_hardening.py} and manual upload validation. \\
\hline

Document Hashing & SHA-256 document integrity metadata. &
Implemented in \texttt{backend/api/v1/routes/documents.py} and \texttt{backend/core/models.py}. Validated by document hash verification evidence and audit evidence. \\
\hline

Audit Logging & Audit event recording for security-relevant workflow actions. &
Implemented in \texttt{backend/api/v1/routes/audit.py}, \texttt{backend/core/models.py}, \texttt{backend/api/v1/routes/cases.py}, and \texttt{backend/api/v1/routes/tickets.py}. Validated by \texttt{tests/test\_workflows.py} and audit UI evidence. \\
\hline

Audit Hash Chain & Previous-hash and event-hash continuity verification. &
Implemented in \texttt{backend/api/v1/routes/audit.py} and \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_audit\_hash\_chain.py}. \\
\hline

Auditor-Only Audit Access & Audit event listing, reports, and hash-chain verification restricted to auditor role. &
Implemented in \texttt{backend/api/v1/routes/audit.py}, \texttt{frontend/src/pages/Audit.tsx}, and \texttt{frontend/src/components/Sidebar.tsx}. Validated by \texttt{tests/test\_workflows.py}. \\
\hline

Audit Pagination & Auditor-facing audit event pagination. &
Implemented in \texttt{frontend/src/pages/Audit.tsx} and \texttt{frontend/src/services/dashboard.ts}. Validated by manual browser validation evidence. \\
\hline

Asset Immutability & ORM-level guards preventing modification of seized asset facts. &
Implemented in \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_asset\_immutability.py}. \\
\hline

Frozen Valuation Immutability & ORM-level guards for frozen valuation snapshot fields. &
Implemented in \texttt{backend/core/models.py}. Validated by \texttt{tests/test\_asset\_immutability.py}. \\
\hline

Input Validation & Controlled handling of malformed case IDs, ticket descriptions, and document names. &
Implemented through API route validation and Pydantic request models. Validated by \texttt{tests/test\_fuzz\_security\_inputs.py} and \texttt{tests/test\_security\_hardening.py}. \\
\hline

Controlled Error Handling & Client errors for invalid input instead of unhandled server failures. &
Implemented across backend API routes. Validated by \texttt{tests/test\_fuzz\_security\_inputs.py} and \texttt{tests/test\_security\_hardening.py}. \\
\hline

Container Hardening & Non-root containers, dropped capabilities, no-new-privileges, and read-only backend filesystem. &
Implemented in \texttt{docker-compose.yml}, \texttt{backend/Dockerfile}, and \texttt{frontend/Dockerfile}. Validated by \texttt{docker compose config} and Trivy evidence. \\
\hline

Security Headers & Baseline HTTP security headers for backend and frontend responses. &
Implemented in \texttt{backend/main.py} and \texttt{frontend/vite.config.ts}. Validated by frontend build, manual header validation, and security triage evidence. \\
\hline

DevSecOps Evidence & CI security scanners and retained evidence artifacts. &
Implemented in \texttt{.gitlab-ci.yml}, \texttt{docs/evidence/}, and \texttt{scripts/security\_reports\_to\_html.py}. Validated through GitLab CI artifacts and HTML reports. \\
\hline

Software Composition Analysis & Backend and frontend dependency audit evidence. &
Implemented through \texttt{backend/requirements.txt}, \texttt{frontend/package-lock.json}, and CI jobs in \texttt{.gitlab-ci.yml}. Validated by \texttt{pip-audit}, \texttt{npm audit}, and CI evidence. \\
\hline

SAST and Secret Scanning & Static analysis and secret detection. &
Implemented in \texttt{.gitlab-ci.yml}. Validated by Bandit, Semgrep, and Gitleaks artifacts. \\
\hline

Container and IaC Scanning & Container image and configuration scanning. &
Implemented in \texttt{.gitlab-ci.yml}, \texttt{docker-compose.yml}, and Dockerfiles. Validated by Trivy and Checkov artifacts. \\
\hline

DAST Evidence & OWASP ZAP baseline scan against the frontend target. &
Implemented in \texttt{.gitlab-ci.yml} and \texttt{docs/evidence/dast/README.md}. Validated by ZAP JSON, HTML, and Markdown artifacts. \\
\hline

Manual Validation & Human review of role behavior, workflow behavior, audit visibility, and evidence artifacts. &
Documented in docs/evidence/
\texttt{manual-validation/README.md} 
and \texttt{README.md}. Validated by the manual validation checklist and screenshots. \\
\hline

Security Triage & Review of scanner findings, residual risks, and deferred controls. &
Documented in docs/evidence/ \texttt{security-triage/README.md}. Validated by security triage documentation. \\
\hline

\caption{Granular mapping of implemented security controls to current SCFCAv2 files, tests, and validation evidence.}
\label{tab:granular-security-mapping}
\end{longtable}

\endgroup

\chapter {Reproducibility and Validation Evidence}
\label{app:reproducibility-validation-evidence}

This appendix provides screenshot evidence collected during the final reproducibility and validation run of the SCFCA proof of concept. The screenshots support the final validation described in Chapter~\ref{ch:implementation-validation-poc}, including Docker Compose execution, backend health checks, seeded demo data, automated tests, frontend build validation, role-based workflow validation, administrator re-authentication, auditor review, audit report generation, hash verification, and DevSecOps/DAST evidence.

The purpose of this appendix is not to introduce new requirements or new implementation claims. Its purpose is to preserve visual evidence that the final repository state can be executed and reviewed following the documented proof-of-concept workflow.

\section{Runtime, Build, and Test Validation Evidence}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure32.png}
    \caption{Backend application import validation and start of the automated test execution from the final repository state.}
    \label{fig:appendix-app-import-test-start}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure33.png}
    \caption{Automated test-suite result showing \texttt{59 passed} tests during the final reproducibility check.}
    \label{fig:appendix-pytest-59-passed}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure34.png}
    \caption{Frontend production build validation using \texttt{npm run build}.}
    \label{fig:appendix-frontend-build-success}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure35.png}
    \caption{Backend health-check request returning \texttt{200 OK} from \texttt{/api/v1/health/}.}
    \label{fig:appendix-backend-health-check}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure36.png}
    \caption{Docker Compose runtime showing PostgreSQL, backend, and frontend services running during the proof-of-concept validation.}
    \label{fig:appendix-docker-compose-runtime}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure37.png}
    \caption{Demo database seeding output showing users, cases, shared-case data, assets, documents, tickets, and audit events generated for reproducible validation.}
    \label{fig:appendix-demo-seed-output}
\end{figure}

\section{Role-Based Workflow Validation Evidence}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure38.png}
    \caption{Login screen used to access the SCFCA proof of concept with role-specific demo accounts.}
    \label{fig:appendix-login-screen}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure39.png}
    \caption{Regular-user case list showing assignment-scoped custody case visibility for \texttt{alice}.}
    \label{fig:appendix-alice-assigned-cases}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure40.png}
    \caption{Regular-user ticket list showing read-only ticket visibility and assigned-case workflow context for \texttt{alice}.}
    \label{fig:appendix-alice-ticket-list}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure41.png}
    \caption{Regular-user custody request overview showing ticket-based custody requests and proof-of-concept scope notes.}
    \label{fig:appendix-alice-custody-requests}
\end{figure}

\section{Administrator Workflow and Re-authentication Evidence}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure44.png}
    \caption{Regular-user case detail view showing supporting PDF upload capability for an assigned custody case.}
    \label{fig:appendix-alice-supporting-pdf-upload}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure45.png}
    \caption{Administrator ticket list showing system-wide ticket visibility and approval/rejection actions.}
    \label{fig:appendix-admin-open-tickets}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure46.png}
    \caption{Administrator password-confirmation prompt required before approving a custody workflow ticket.}
    \label{fig:appendix-admin-ticket-reauth-prompt}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure47.png}
    \caption{Administrator case creation form used to register a new wallet custody case and assign a handler.}
    \label{fig:appendix-admin-case-creation-form}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure48.png}
    \caption{Administrator password-confirmation prompt required before creating a new custody case.}
    \label{fig:appendix-admin-case-creation-reauth}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure49.png}
    \caption{Administrator closed-ticket view showing approved and rejected workflow outcomes with approval history.}
    \label{fig:appendix-admin-closed-tickets}
\end{figure}

\section{Auditor Review, Reporting, and Integrity Verification Evidence}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure50.png}
    \caption{Newly created custody case visible in the case list after administrator case creation.}
    \label{fig:appendix-created-case-visible}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure51.png}
    \caption{Auditor dashboard showing read-only audit visibility and recent security-relevant activity.}
    \label{fig:appendix-auditor-dashboard}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure52.png}
    \caption{Auditor audit-events page showing filters, event counters, hash verification area, and paginated audit evidence.}
    \label{fig:appendix-auditor-audit-events}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure53.png}
    \caption{Generated HTML audit report showing exported audit-event evidence from the SCFCA proof of concept.}
    \label{fig:appendix-html-audit-report}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure54.png}
    \caption{Auditor-facing hash verification showing a matched audit-event hash in the database-backed evidence trail.}
    \label{fig:appendix-hash-verification-matched}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure55.png}
    \caption{Auditor view of internal communication messages, demonstrating read-only oversight of system activity visible to the auditor role.}
    \label{fig:appendix-internal-chat-auditor-view}
\end{figure}

\FloatBarrier

\section{DevSecOps and DAST Evidence}

The following figures show the OWASP ZAP baseline DAST evidence before and after a remediation step. The first report identified browser-policy and security-header findings. After mitigation, the scan was repeated and the updated report showed a reduced set of findings. The remaining alerts are retained as evidence for review and future hardening rather than hidden or overstated as fully resolved.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure28.png}
    \caption{Initial OWASP ZAP baseline report generated against the SCFCA frontend target before remediation, showing the baseline DAST alert summary.}
    \label{fig:appendix-zap-initial-summary}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure29.png}
    \caption{Initial OWASP ZAP alert table before remediation, showing detected web security findings such as missing security headers and related browser-policy controls.}
    \label{fig:appendix-zap-initial-alerts}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure30.png}
    \caption{OWASP ZAP baseline report after remediation, showing the updated risk summary following mitigation of one previously detected finding.}
    \label{fig:appendix-zap-post-remediation-summary}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure31.png}
    \caption{OWASP ZAP post-remediation sequence summary showing the remaining medium, low, and informational findings after the mitigation step.}
    \label{fig:appendix-zap-post-remediation-alerts}
\end{figure}
...
\section{Software Composition Analysis Testing}

Software Composition Analysis (SCA) was performed to identify potential vulnerabilities in third-party dependencies used by the SCFCAv2 proof-of-concept implementation. In addition to standard ecosystem-specific scanners, a custom SCA tool \cite{scatool} developed by the author was executed against the repository. The purpose of this test was not to prove that the system is free of vulnerabilities, but to collect dependency-risk evidence and compare custom scanner output with established tools.

The custom tool was executed against the full SCFCAv2 repository and separately against the backend and frontend components. It generated human-readable HTML reports, JSON output, SARIF output, and console evidence. The resulting artifacts were stored in the repository under the security testing evidence directory:

\begin{center}
\url{https://github.com/Blackbirdf16/SCFCAv2/tree/main/docs/evidence/security-testing}
\end{center}

The backend scan reported multiple vulnerability candidates, including findings related to FastAPI, SQLAlchemy, Pydantic, python-multipart, Uvicorn, and other Python packages. However, several of these results were marked as low confidence and version unknown, meaning that they were detected heuristically and required manual validation before being treated as confirmed vulnerabilities. The frontend scan also reported a low-confidence Streamlit finding, but this was not confirmed from a frontend dependency manifest.

To avoid overclaiming the results of the custom scanner, the findings were compared with established dependency analysis tools. The backend Python dependencies were checked with \texttt{pip-audit}, while the frontend JavaScript dependencies were checked with \texttt{npm audit}. This comparison was necessary because custom SCA output may contain false positives when dependency versions cannot be resolved precisely. In the local comparison test, \texttt{pip-audit} did not confirm known vulnerabilities in the backend dependency manifest, while \texttt{npm audit} reported moderate-severity frontend dependency findings requiring triage.

Therefore, the custom SCA tool was treated as a supporting validation artifact rather than a definitive vulnerability authority. This approach improves the credibility of the security testing process by combining custom security experimentation with recognized ecosystem-specific scanners.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure56.png}
    \caption{Custom SCA tool execution and generated evidence artifacts for the SCFCAv2 repository.}
    \label{fig:sca-custom-tool-execution}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure57.png}
    \caption{Custom SCA backend report showing dependency and vulnerability candidate summary.}
    \label{fig:sca-backend-report-summary}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure58.png}
    \caption{Execution of the custom SCA tool to generate backend and frontend HTML evidence reports for SCFCAv2.}
    \label{fig:sca-custom-report-generation}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure59.png}
    \caption{Version-control evidence showing the custom SCA reports committed and pushed to the SCFCAv2 repository.}
    \label{fig:sca-custom-evidence-commit}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure60.png}
    \caption{Custom SCA backend report showing low-confidence vulnerability candidates detected in backend dependencies.}
\label{fig:sca-backend-low-confidence-findings}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{docs/thesis-notes/figure61.png}
    \caption{Frontend dependency validation using \texttt{npm audit}.}
    \label{fig:sca-npm-audit-frontend}
\end{figure}
